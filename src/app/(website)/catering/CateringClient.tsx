    ...
    return (
        <>
            <div className='container py-[100px]'>
                ...
                <div className='grid grid-cols-12 h-[481px] gap-10 mb-20'>
                    ...
                    <div className="col-span-6 h-[481px] relative">
                        <Image
                            alt="Catering"
                            src={Catering}
                            fill
                ...
                <Heading name='Perfect for any occasion' style='font-bold text-center text-[40px] leading-[46px] text-[#333333] mb-[60px]' />

                <div className='w-[876px] grid grid-cols-3 gap-6 mx-auto'>
            ...
            <div className='grid grid-cols-12 h-[429px] pb-10'>
                ...
                <div className='relative col-span-6 bg-[#F4F4F4] py-6'>
                    <div className='absolute w-[200px] h-full bg-[#FDB64E] z-10 right-0 top-0'/>
                    <div className="ml-[46px] bg-[#3E3E3E] h-full flex flex-col items-start justify-center relative z-0">
                        <div className='p-6'>
